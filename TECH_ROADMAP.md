...
| **M5** | 🔄 进行中（5.1 ✅ 5.2 ✅ 5.3 ✅ 5.7 ✅ 5.8 ✅ 5.9 ✅ / 剩 5.4 幂等、5.6 错误码 —— 两个都要动前端，见下方说明；5.5 验证码为可选） | **D + E**：traceId、索引与压测、指标、登出失效、安全头 | 面试纵深：**这些是"做过才答得出"的细节** |
...
> ### 🔄 进度：5.1 ✅ · 5.2 ✅ · 5.3 ✅ · 5.7 ✅ · 5.8 ✅ · 5.9 ✅（6/9）
> 剩：**5.4 幂等**与**5.6 错误码统一** —— 这两个都要动前端，先确认再动；
> 5.5 登录验证码当时标的就是"可选"，暂不做。
>
> **5.8 已完成**（本次提交）：连接池参数 + 压测对比，而且压测**压出了一个真问题**。
>
