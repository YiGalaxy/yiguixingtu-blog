...
>
> **当前进度：web-0 ✅ / web-1 ✅ / web-2 ✅ / web-3 ✅ / web-4 ✅ / web-5 ✅，web-6（按需）、web-7 待做。**
> 前端三件套在 HEAD 上实测：`eslint .` 0 问题、**13 个测试文件 214 个用例全绿**、`npm run build` 通过
> （用例数一路是 53 → 92 → 121 → 132 → 167 → 189 → 205 → 214）。
